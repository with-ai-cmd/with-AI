...
add_numbered(1, '本契約は、甲乙間で合意した開始日より効力を生じ、甲または乙のいずれかが解約の意思表示をするまで継続するものとする。')
...
add_numbered(4, '本条の義務は、本契約終了後も3年間存続するものとする。')
...
add_numbered(3, '損害賠償の額は、損害の原因となった事由が生じた月から遡って過去6ヶ月間に乙が甲に支払った月額料金の総額を上限とする。ただし、故意または重大な過失による場合はこの限りでない。')
...
# 保存
output_path = '/Users/kaitomain/Desktop/クロードコード/AIKOMON_業務委託契約書.docx'
