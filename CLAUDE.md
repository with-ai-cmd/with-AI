...
## CMO（最高マーケティング責任者AI）
マーケティング戦略・集客・ブランディング・コンテンツ全体を統括する。
- 定義: `{{WITHAI_ROOT}}/cmo/CMO.md`
- エントリポイント: `skills/meta/cmo.md`
- 配下スキル: `skills/marketing/` 配下の全スキル
...
### 「CMO」「マーケ」「集客」「コンテンツ戦略」「ブランディング」
→ `skills/meta/cmo.md` を読み込み、CMO マーケティングモードを起動する。
...
| meta | cmo.md | CMO、マーケ、集客、SEO、ブログ、SNS、LP改善、コンテンツ戦略 |
